...
from utility.helper import psnr, load_imgs, regroup
...
def residue_train(folder, start, end, bm, b, pred):
 ...
 # ============== YL ===============================
    ...
    with open("./models/BlowingBubbles_416x240_50_residue12.json", "w") as json_file:
    ...
    checkpointer = ModelCheckpoint(filepath='./models/BlowingBubbles_416x240_50_residue12.hdf5',\
