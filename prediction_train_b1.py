...
from utility.helper import psnr, load_imgs, get_block_set
...
def pred_train(folder, start, end, b, bm):
    ...
    with open("./models/BlowingBubbles_416x240_50_pred12_b1.json", "w") as json_file:
    ...
    checkpointer = ModelCheckpoint(filepath='./models/BlowingBubbles_416x240_50_pred12_b1.hdf5',\
