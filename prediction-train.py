...
def pred_train(folder, start, end, b, bm):
   ...
   # from keras.models import model_from_json
    ...
    with open("./models_new/BlowingBubbles_416x240_50_pred16.json", "w") as json_file:
    ...
    checkpointer = ModelCheckpoint(filepath='./models_new/BlowingBubbles_416x240_50_pred16.hdf5',\
