...
def residue_train(N_frames, bm, b, images, predicted_b1_frame):
 ...
 # ============== YL ===============================
    ...
    with open("./models/BlowingBubbles_416x240_50_residue12_b1.json", "w") as json_file:
    ...
    checkpointer = ModelCheckpoint(filepath='./models/BlowingBubbles_416x240_50_residue12_b1.hdf5',\
