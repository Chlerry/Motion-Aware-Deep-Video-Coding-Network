...
def model(images, decoded, b, bm, ratio):
    ...
    z = Conv2D(128, kernel_size=(5, 5), padding = "SAME", strides = 1, activation='relu')(z)
    z = Conv2D(64, kernel_size=(5, 5), padding = "SAME", strides = 1, activation='relu')(z)
    z = Conv2D(32, kernel_size=(5, 5), padding = "SAME", strides = 1, activation='relu')(z)
    z = Conv2D(16, kernel_size=(5, 5), padding = "SAME", strides = 1, activation='relu')(z)
    z = Conv2D(8, kernel_size=(5, 5), padding = "SAME", strides = 1, activation='relu')(z)
    ...
    # ============== DL ===============================
    json_path, hdf5_path = get_model_path("prediction_gnet8", ratio)

    delta, n_patience, batch_size, epoch_size = get_training_parameter("prediction_gnet8")
    # ============== YL ===============================
