...
def model(images, decoded, b, bm, ratio):
    ...
    y0c = Conv2D(4, kernel_size=(7, 7), padding = "SAME", strides = 1, activation='relu')(y)
    ...
    y1c = Conv2D(8, kernel_size=(7, 7), padding = "SAME", strides = 1, activation='relu')(yc0)
    ...
    x0c = Conv2D(4, kernel_size=(7, 7), padding = "SAME", strides = 1, activation='relu')(x)
    ...
    x1c = Conv2D(8, kernel_size=(7, 7), padding = "SAME", strides = 1, activation='relu')(xc0)
    ...
    # ============== DL ===============================
    json_path, hdf5_path = get_model_path("prediction_gnet3", ratio)

    delta, n_patience, batch_size, epoch_size = get_training_parameter("prediction_gnet3")
    # ============== YL ===============================
